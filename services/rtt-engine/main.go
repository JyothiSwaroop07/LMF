...
func main() {
	...
	// pb.RegisterRttEngineServiceServer(srv, server.NewRttServer(logger))
	reflection.Register(srv)

	logger.Info("RTT Engine gRPC server starting", zap.String("addr", cfg.GRPC.ListenAddr()))
	...
	logger.Info("shutting down RTT Engine")
	srv.GracefulStop()
