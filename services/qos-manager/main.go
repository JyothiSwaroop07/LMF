...
func main() {
	...
	// pb.RegisterQosManagerServiceServer(srv, server.NewQosServer(logger))
	reflection.Register(srv)

	logger.Info("QoS Manager gRPC server starting", zap.String("addr", cfg.GRPC.ListenAddr()))
	...
	logger.Info("shutting down QoS Manager")
	srv.GracefulStop()
